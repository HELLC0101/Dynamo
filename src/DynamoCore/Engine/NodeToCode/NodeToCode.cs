...
namespace Dynamo.Engine.NodeToCode
{
    ...
    internal class NodeToCode
    {
        ...
        /// </summary>
        internal static bool IsInternalNodeToCodeConnection(IEnumerable<NodeModel> nodes, ConnectorModel connector)
        {
        ...
        internal static List<ConnectorModel> ReConnectOutputConnections(Dictionary<ConnectorModel, string> externalOutputConnections, 
            CodeBlockNodeModel cbn)
        {
        ...
        /// <param name="cbn">The new Node To Code created Code Block Node</param>
        internal static List<ConnectorModel> ReConnectInputConnections(
